<template>
    <div>
        <div class="idCard-upload-banner">
            ...
            <el-form style="float:right" size="small" :inline="true" :model="searchEditForm" status-icon label-width="110px" @submit.native.prevent>
        ...
        <div class="idCard-upload-banner" style="padding-bottom: 20px" v-if="searchEditForm.searchOn">
...
export default {
    ...
    mounted () {
        if (this.$route.query.recipientName && this.$route.query.recipientCellphoneNumber) {
            this.searchEditForm.recipientName = this.$route.query.recipientName
            this.searchEditForm.recipientCellphoneNumber = this.$route.query.recipientCellphoneNumber
            this.queryOrder()
        }
    }
}
...
<style lang="less">
    .idCard-upload-banner {
        // height: 80px;
        // line-height: 80px;
        border-bottom: solid 2px #adadad;
        padding-bottom: 10px; // color: #848484;
        margin-bottom: 20px;
        // font-size: 30px;
        // .el-input{
        //     width: 500px
