    ...
    <div>
        ...
        <div v-else class="main">
            <div class="letter-box">
                <el-col :span="8"  v-for="order in orders" :key="order._id">
                    <div class="order-box">
                        <div class="order-content">
                            <div class="top">
                                <div class="barcode">
                                    <barcode :value="order.orderNumber" :height="56" :width="2.4" :fontSize="18" :textMargin="-5" :displayValue="false"></barcode>
                                </div>
                            ...
                            <div class="body">
                                ...
                                <el-row style="margin-top: 1mm">
                                    ...
                                    <el-col :span="12"><span style="font-size: 20px;">{{order.senderName}}</span></el-col>
                                </el-row>
                                <el-row style="margin-top: 1mm">
                                    <el-col :span="12">收件人/To:</el-col>
                                    <el-col :span="12"><span style="font-size: 20px;">{{order.recipientName}}</span></el-col>
                                </el-row>
                                <el-row style="margin-top: 1mm">
